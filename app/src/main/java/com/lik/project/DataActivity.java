...
public class DataActivity extends AppCompatActivity {
    ...
    ArrayList<String> book_id, book_title, book_author, book_pages, book_years;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book_years = new ArrayList<>();

        storeDataInArrays();

        customAdapter = new CustomAdapter(DataActivity.this, this,
                book_id, book_title, book_author, book_pages, book_years);
    ...
    void storeDataInArrays(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                book_years.add(cursor.getString(4));
            }
