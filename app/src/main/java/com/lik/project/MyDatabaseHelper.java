...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_YEARS = "book_years";
    ...
    void addBook(String title, String author, int pages, String years){
    ...
    void updateData(String row_id, String title, String author, String pages, String years){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_TITLE, title);
        cv.put(COLUMN_AUTHOR, author);
